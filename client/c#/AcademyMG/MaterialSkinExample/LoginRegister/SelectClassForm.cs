...
namespace MaterialSkinExample.LoginRegister
{
    public partial class SelectClassForm : MaterialForm
    {
        ...
        public SelectClassForm(MainForm mainForm, MaterialSingleLineTextField tf) : this()
        {
        ...
        private async void materialRaisedButton1_Click(object sender, EventArgs e)
        {
            if (materialListView1.SelectedItems.Count > 0)
            {
                ...
                if (result.flag)
                {
                    ...
                    if (mainForm != null) mainForm.class_id = Int32.Parse(materialListView1.SelectedItems[0].Text);
